...
function Router() { return <Switch><Route path="/" component={Home} /><Route path="/transmissions" component={Archive} /><Route path="/transmissions/:id" component={TransmissionDetail} /><Route path="/studio" component={Studio} /><Route path="/production" component={ProductionLab} /><Route path="/tools" component={Studio} />
<Route path="/account" component={Account} /><Route path="/about" component={About} />
