...
export default function SiteHeader() {
  ...
  const labels = language === "ru" ? { transmissions: "Трансляции", tools: "Студия", production: "Производство", notes: "Заметки", contact: "Контакт" } : { transmissions: "Transmissions", tools: "Studio", production: "Production", notes: "Signal notes", contact: "Contact" };
