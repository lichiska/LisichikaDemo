...
export default function SiteHeader() {
  ...
  const labels = language === "ru" ? { transmissions: "Трансляции", tools: "Студия", notes: "Заметки", contact: "Контакт" } : { transmissions: "Transmissions", tools: "Studio", notes: "Signal notes", contact: "Contact" };
